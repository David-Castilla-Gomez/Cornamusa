...
int desensamblar_instruccion(const Chunk *c, int offset, FILE *out) {
    ...
    switch ((OpCode)op) {
        ...
        case OP_CONJUNTO_EXTENDER: return instruccion_simple("OP_CONJUNTO_EXTENDER", offset, out);
        case OP_LISTA_A_TUPLA:   return instruccion_simple("OP_LISTA_A_TUPLA", offset, out);
        ...
        case OP_ES_DICC:         return instruccion_simple("OP_ES_DICC", offset, out);
        case OP_FORMATO_F_SPEC_DIN: return instruccion_simple("OP_FORMATO_F_SPEC_DIN", offset, out);
        case OP_DICC_RESTO:      return instruccion_byte("OP_DICC_RESTO", c, offset, out);
