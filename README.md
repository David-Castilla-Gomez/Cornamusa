...
[![Versión](https://img.shields.io/badge/versión-1.20.0-blue.svg)](CHANGELOG.md)
...
| v1.21+ | generadores (`producir`), `__siguiente__` lazy, dunders `__hash__`/`__repr__`/`__booleano__` | ⏳ |
