...
[![Versión](https://img.shields.io/badge/versión-1.19.0-blue.svg)](CHANGELOG.md)
...
| v1.20+ | generadores (`producir`), `__siguiente__` lazy, dunders `__hash__`/`__repr__`/`__booleano__`, dict orden inserción | ⏳ |
