...
[![Versión](https://img.shields.io/badge/versión-1.16.2-blue.svg)](CHANGELOG.md)
...
| v1.17+ | generadores (`producir`), `formato`, `fechas`, `__siguiente__` lazy, dunders `__hash__`/`__repr__` | ⏳ |
