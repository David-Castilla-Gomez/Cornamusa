...
[![Versión](https://img.shields.io/badge/versión-1.11.0-blue.svg)](CHANGELOG.md)
...
| v1.12+ | dunders de iteración (`__iterar__`/`__siguiente__`), context managers (`con`), `formato`, `fechas` | ⏳ |
