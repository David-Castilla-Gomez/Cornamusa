...
[![Versión](https://img.shields.io/badge/versión-1.95.0-blue.svg)](CHANGELOG.md)
...
**Biblioteca estándar** — veintidós módulos: `matematicas`, `cadenas`, `funcionales`, `formato`, `archivos`, `json`, `csv`, `fechas`, `tiempo`, `azar`, `proceso`, `regex`, `red`, `sistema`, `base64`, `hashing`, `jwt`, `coleccion`, `inspeccion`, `validacion`, `argumentos`, `ruta`.
