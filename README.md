...
[![Versión](https://img.shields.io/badge/versión-1.24.0-blue.svg)](CHANGELOG.md)
...
| v1.25+ | spread `**dict`, generadores (`producir`), comprehensions, stdlib `azar`/`regex`/`proceso`/`red` | ⏳ |
