...
[![Versión](https://img.shields.io/badge/versión-1.13.0-blue.svg)](CHANGELOG.md)
...
| v1.14+ | pattern matching (`coincidir`), generadores (`producir`), `formato`, `fechas`, `__siguiente__` lazy | ⏳ |
