...
[![Versión](https://img.shields.io/badge/versión-1.14.0-blue.svg)](CHANGELOG.md)
...
| v1.15+ | pattern matching (`coincidir`), generadores (`producir`), `formato`, `fechas`, `__siguiente__` lazy | ⏳ |
